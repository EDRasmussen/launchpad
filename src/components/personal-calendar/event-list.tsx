import { EventEntryProps, EventListProps } from "./types";
import {
    HoverCard,
    HoverCardContent,
    HoverCardTrigger,
    ...
    return (
        <HoverCard openDelay={10} closeDelay={100}>
            <HoverCardTrigger asChild>
                <div className={`text-muted-foreground ${isEventCanceled(event.summary) ? 'line-through' : ''}`}>
            ...
            <HoverCardContent side="right" className="flex w-64 max-h-64 overflow-y-scroll flex-col gap-0.5">
